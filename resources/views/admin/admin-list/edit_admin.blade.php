                                    ...
                                    <div class="col-md-12">
                                        <form action="{{ route('admin.admin.update', $admin->id) }}" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-6">
                                                    <x-admin.form-input type="password"  id="password"  name="password" label="{{ __('Password') }}" placeholder="{{ __('Enter Password') }}" required="true"/>
                                                </div>
                                                <div class="form-group col-6">
                                                    <x-admin.form-select id="role" name="role[]"
                                                        label="{{ __('Assign Role') }}" class="select2" required="true" multiple>
                                                        <x-admin.select-option value="" text="{{ __('Select Role') }}" />
