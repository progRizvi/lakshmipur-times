    ...
    <!-- Pay with stripe -->
    <a href="javascript:;" class="btn btn-primary" onclick="event.preventDefault(); $('#stripe-form').trigger('submit');">Pay with Stripe</a>
    <form id="stripe-form" action="{{ route('pay-via-stripe') }}" method="POST" class="d-none">
        @csrf
    </form>
    <!-- Pay with SslCommerz -->
    <a href="javascript:;" class="btn btn-primary" onclick="event.preventDefault(); $('#SslCommerz-form').trigger('submit');">Pay with SslCommerz</a>
    <form id="SslCommerz-form" action="{{ route('pay-via-sslcommerz') }}" method="POST" class="d-none">
        @csrf
    </form>
    <!-- Pay with Crypto -->
    <a href="{{ route('pay-via-crypto') }}" class="btn btn-primary">
        Pay with Crypto
    </a>
