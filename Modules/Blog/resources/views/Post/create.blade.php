...
@section('admin-content')
    <div class="main-content">
        <section class="section">
            <x-admin.breadcrumb title="{{ __('Create News') }}" :list="[
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <x-admin.form-title :text="__('Create News')" />
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <x-admin.form-editor id="short_description" name="short_description"
                                                label="{{ __('Short Description') }}" value="{!! old('short_description') !!}"
                                                required="true" />
                                        </div>
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-4">
                                            <x-admin.form-select name="state_id" id="state_id" class="select2"
                                                ...
                                                @foreach ($states as $index => $state)
                                                    <x-admin.select-option :selected="$index == 0 || $state->id == old('state_id')" value="{{ $state->id }}"
                                                        text="{{ $state->name }}" />
                                                @endforeach
                                            </x-admin.form-select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <x-admin.form-select name="city_id" id="city_id" class="select2"
                                                ...
                                                @foreach ($cities as $city)
                                                    <x-admin.select-option :selected="$city->id == old('city_id')" value="{{ $city->id }}"
                                                        text="{{ $city->name }}" />
                                                @endforeach
                                            </x-admin.form-select>
                                        </div>
