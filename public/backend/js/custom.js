(function ($) {
    ...
    $(document).ready(function () {
        tinymce.init({
            ...
            menubar: false,
            plugins:
                "anchor autolink charmap link lists searchreplace visualblocks wordcount image table",
            toolbar:
                "blocks fontsize | bold italic underline | link | align lineheight | numlist bullist | image",
